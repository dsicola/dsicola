...
export function listarCamposDisponiveis(): AvailableField[] {
  return [
    ...
    { caminho: 'student.disciplinasPivot', descricao: 'Pivot Angola (10ª–13ª) — Secundário: {#student.disciplinasPivot}{disciplina}{classe10}{classe11}{classe12}{classe13}{/student.disciplinasPivot}. classe13 = ------- se só 3 anos.', contexto: 'student' },
