  ...
  // ==================== ACADÊMICO ====================
  {
    ...
    items: [
      ...
      },
      {
        label: 'Classes (anos)',
        icon: BookOpen,
        path: '/admin-dashboard/gestao-academica?tab=classes',
        roles: ['ADMIN', 'SECRETARIA', 'DIRECAO', 'COORDENADOR'],
      },
      {
        label: 'Regras de aprovação',
        icon: Scale,
        path: '/admin-dashboard/gestao-academica?tab=regras-aprovacao',
        roles: ['ADMIN', 'DIRECAO', 'COORDENADOR', 'SUPER_ADMIN'],
      },
      {
        label: 'Disciplinas chave',
        icon: KeyRound,
        path: '/admin-dashboard/gestao-academica?tab=disciplinas-chave',
        roles: ['ADMIN', 'DIRECAO', 'COORDENADOR', 'SUPER_ADMIN'],
      },
      {
