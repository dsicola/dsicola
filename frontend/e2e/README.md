...
# Modelos e Mapeamento de Documentos (CRUD, Excel CELL_MAPPING, preview)
# Opção automática (inicia backend + frontend + seeds):
./scripts/run-e2e-modelos-mapeamento.sh
# Ou manualmente (com backend e frontend já a correr):
