...
import pagamentoServicoRoutes from './pagamento-servico.routes.js';
...
import documentoFinanceiroRoutes from './documentoFinanceiro.routes.js';
import agtRoutes from './agt.routes.js';
...
router.use('/pagamentos-servico', pagamentoServicoRoutes);
...
router.use('/documentos-financeiros', documentoFinanceiroRoutes);
router.use('/agt', agtRoutes);
...
router.use('/academic', academicProgressionRoutes);
