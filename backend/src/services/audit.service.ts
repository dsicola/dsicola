...
export enum ModuloAuditoria {
  ...
  CONTABILIDADE = 'CONTABILIDADE', // Plano de contas, lançamentos, centros de custo
}
...
export enum EntidadeAuditoria {
  ...
  // Novas entidades para cobertura total
  DISCIPLINA = 'DISCIPLINA',
  TURMA = 'TURMA',
  CURSO = 'CURSO',
  FUNCIONARIO = 'FUNCIONARIO',
  DOCUMENTO_ALUNO = 'DOCUMENTO_ALUNO',
  PAGAMENTO_INSTITUICAO = 'PAGAMENTO_INSTITUICAO',
  MATRICULA_ANUAL = 'MATRICULA_ANUAL',
  ALUNO_DISCIPLINA = 'ALUNO_DISCIPLINA',
  ...
  ALOCACAO_ALOJAMENTO = 'ALOCACAO_ALOJAMENTO',
  BOLSA = 'BOLSA',
  ALUNO_BOLSA = 'ALUNO_BOLSA',
  ...
  PROFESSOR_VINCULO = 'PROFESSOR_VINCULO',
  FREQUENCIA = 'FREQUENCIA',
  HISTORICO_RH = 'HISTORICO_RH',
  CONFIGURACAO_MULTA = 'CONFIGURACAO_MULTA',
  TURNO = 'TURNO',
...
export enum AcaoAuditoria {
  ...
  TRIMESTRE_INICIADO_AUTOMATICO = 'TRIMESTRE_INICIADO_AUTOMATICO',
  PERIODO_LANCAMENTO_NOTAS_ABERTO_AUTOMATICO = 'PERIODO_LANCAMENTO_NOTAS_ABERTO_AUTOMATICO',
  // Ano Letivo
  ANO_LETIVO_ATIVADO_AUTOMATICO = 'ANO_LETIVO_ATIVADO_AUTOMATICO',
...
export class AuditService {
  ...
  private static isModuloAcademico(modulo?: ModuloAuditoria | string): boolean {
    const modulosAcademicos = [
      ...
      ModuloAuditoria.PERIODO_LANCAMENTO_NOTAS,
