...
import { authenticate, authenticateDocumentoArquivo, authorize } from '../middlewares/auth.js';
...
router.get('/:id/arquivo', authenticateDocumentoArquivo, documentoAlunoController.getArquivo);
