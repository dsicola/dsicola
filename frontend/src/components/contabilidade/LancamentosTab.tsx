...
import { Plus, Edit, Trash2, Lock, FileText } from 'lucide-react';
            ...
            <TableBody>
              {lancamentos.map((l: Lancamento) => (
                <TableRow key={l.id}>
                  ...
                  <TableCell>
                    <Badge variant={l.fechado ? 'secondary' : 'default'}>{l.fechado ? 'Fechado' : 'Aberto'}</Badge>
                  </TableCell>
                  <TableCell>
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" onClick={() => handleEdit(l)} disabled={l.fechado} title="Editar">
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSubmit} disabled={!balanceado || createMutation.isPending || updateMutation.isPending}>
