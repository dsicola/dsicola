...
import { Users, Plus, Shield, Edit, Trash2, KeyRound, Mail, Phone, Calendar, Eye, EyeOff } from 'lucide-react';
...
export const SuperAdminUsersTab = () => {
  ...
  const createMutation = useSafeMutation({
    ...
    onError: (error: any) => {
      toast.error(error.response?.data?.message || error.message || 'Erro ao criar super admin');
    },
  });
  ...
  const updateMutation = useSafeMutation({
    ...
    onSuccess: () => {
      toast.success('Super Admin atualizado com sucesso!');
      setIsEditDialogOpen(false);
      setSelectedUser(null);
      fetchSuperAdmins();
    },
    onError: (error: any) => {
      toast.error(error.response?.data?.message || error.message || 'Erro ao atualizar super admin');
    },
  });
  ...
  const deleteMutation = useSafeMutation({
    ...
    onSuccess: () => {
      toast.success('Super Admin excluído com sucesso!');
      setIsDeleteDialogOpen(false);
      setSelectedUser(null);
      fetchSuperAdmins();
    },
    onError: (error: any) => {
      toast.error(error.response?.data?.message || error.message || 'Erro ao excluir super admin');
    },
  });
  ...
  const handleCreateSubmit = async (e: React.FormEvent) => {
    ...
    // Validar senha forte para SUPER_ADMIN
  ...
  const handlePasswordReset = (user: SuperAdminUser) => {
    setSelectedUser(user);
    setPasswordFormData({ newPassword: '', confirmPassword: '', sendEmail: false });
        ...
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="flex items-center gap-2">
              ...
              👥 Administradores de Sistema (SUPER_ADMIN)
            </CardTitle>
            <CardDescription>
              Gerencie todos os administradores globais da plataforma DSICOLA
            </CardDescription>
          </div>
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Crie um novo usuário com permissões de Super Administrador
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleCreateSubmit} className="space-y-4">
                ...
                <DialogFooter>
                  ...
                  <Button 
                    type="submit" 
                    disabled={createMutation.isPending || !createFormData.password || !isPasswordStrong(createFormData.password, true)}
                  >
                      ...
                      <div className="flex items-center justify-end gap-2">
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent><p>Editar super admin</p></TooltipContent>
                          </Tooltip>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                          ...
                          <Tooltip>
                            ...
                            <TooltipContent><p>Excluir super admin</p></TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
                    </TableCell>
          ...
          <form onSubmit={handleEditSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                ⚠️ Alterar o e-mail pode afetar o acesso do usuário
              </p>
            </div>
            <div className="space-y-2">
      ...
      <Dialog open={isPasswordDialogOpen} onOpenChange={setIsPasswordDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Redefina a senha do administrador {selectedUser?.nome_completo || selectedUser?.nomeCompleto}
            </DialogDescription>
          </DialogHeader>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir o Super Admin <strong>{selectedUser?.nome_completo || selectedUser?.nomeCompleto}</strong> ({selectedUser?.email})?
              <br />
              <br />
