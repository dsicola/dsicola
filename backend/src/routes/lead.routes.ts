...
import { publicLeadCreateLimiter } from '../middlewares/publicEndpointsRateLimit.middleware.js';
...
router.post('/', publicLeadCreateLimiter, leadController.create); // Public - for lead capture
